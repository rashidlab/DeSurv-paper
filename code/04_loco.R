#!/usr/bin/env Rscript
# code/04_loco.R — Fit final models using LOCO-selected hyperparameters
#
# Identical to code/04_fit_models.R but reads/writes from results/precomputed/loco/

message("=== Step 4 (LOCO): Fit Models ===")
