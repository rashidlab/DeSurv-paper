#!/usr/bin/env Rscript
# code/04_loco_tol.R — Fit final models using LOCO tolerance-selected hyperparameters
#
# Reads params from results/precomputed/loco_tol/ (step 03_loco_tol),
# reuses fit_std and std_nmf_selected_k from results/precomputed/loco/.

message("=== Step 4 (LOCO-tol): Fit Models ===")
...
message("=== Step 4 (LOCO-tol) complete ===")
