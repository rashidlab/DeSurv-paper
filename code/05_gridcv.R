#!/usr/bin/env Rscript
# code/05_gridcv.R — External validation using Grid CV-fitted models
#
# Identical to code/05_loco.R but reads/writes from results/precomputed/gridcv/

message("=== Step 5 (Grid CV): External Validation ===")
...
# ntop not tuned; not used for validation projection
ntop_value <- NULL
...
message("=== Step 5 (Grid CV) complete ===")
