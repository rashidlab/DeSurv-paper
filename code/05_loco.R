#!/usr/bin/env Rscript
# code/05_loco.R — External validation using LOCO-fitted models
#
# Identical to code/05_external_validation.R but reads/writes
# from results/precomputed/loco/

message("=== Step 5 (LOCO): External Validation ===")
