#!/usr/bin/env Rscript
# code/05_loco_tol.R — External validation using LOCO tolerance-selected models
#
# Reads fitted models from results/precomputed/loco_tol/.

message("=== Step 5 (LOCO-tol): External Validation ===")
...
message("=== Step 5 (LOCO-tol) complete ===")
