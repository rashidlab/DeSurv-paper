#!/usr/bin/env Rscript
# code/06_cv_grid.R — Cross-validation grid search for k × alpha × ntop
#
...
message("=== Step 6 complete (figure generated by 09b_si_figures.R) ===")
