...
# survival KM curves (09a_figures.R) and the SI appendix figures
# (09b_si_figures.R).
#
# Inputs:  model fits + filtered training data from steps 02-04
# Outputs: results/desurv_cutpoint_summary_tcgacptac.rds
#          results/desurv_lp_stats_tcgacptac.rds
#          results/std_desurvk_cutpoint_summary_tcgacptac.rds
#          results/std_desurvk_lp_stats_tcgacptac.rds
#
# Runtime: ~5-15 min (depends on n_starts)

message("=== Step 8: Cutpoint analysis ===")
