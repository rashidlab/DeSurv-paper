...
![](figures/defense/fig3_AB_heatmaps.png){width="96%"}
...
## PDAC's highest-variance factors carry the least survival signal

![](figures/defense/new_3c_variance_explained.png){width="55%"}

::: {.notes}
This is the slide-4 cartoon made empirical in PDAC. x-axis: cross-sample variance a factor explains; y-axis: its survival contribution (drop in partial log-likelihood when removed). DeSurv's D1 sits top-left — ~1% of variance, yet by far the largest survival contribution. NMF's N1 and N3 sit bottom-right — most of the variance, essentially zero survival contribution. Variance and prognosis are decoupled; an unsupervised, variance-driven choice walks away from the prognostic factor.
:::
