...
author:
  - name: Amber M. Young
    affiliation: a
    orcid: 0000-0000-0000-0000  # TODO before submission: collect from Amber (no public ORCID record found via ORCID search)
  - name: Alisa Yurovsky
    affiliation: b
...
knitr::opts_chunk$set(
  ...
  fig.path = .fig_path,
  dev = "cairo_pdf", # vector output for PNAS production; dpi applies to embedded raster
  dpi = 300
)
