...
abstract: |
  Pancreatic ductal adenocarcinoma (PDAC) outcomes reflect coordinated tumor-intrinsic and stromal states, but bulk-transcriptomic deconvolution methods split this biology across latent factors that fail to generalize across cohorts. We developed DeSurv, a survival-supervised matrix factorization framework that jointly learns gene programs and their survival association. In pooled TCGA and CPTAC PDAC cohorts, DeSurv recovered a compact three-program structure in which a single factor coupling Classical tumor identity with tumor-restraining CAF (restCAF) stroma captured the dominant prognostic signal. The resulting score generalized across five independent PDAC validation cohorts (Dijk, Moffitt, PACA-AU array and RNA-seq, Puleo), with each standard-deviation shift toward the Basal-tumor / tumor-promoting CAF (proCAF) pole conferring a pooled hazard ratio of 1.50 (95% CI 1.31--1.72, P < 0.001), and retained independent prognostic value after adjustment for the established PurIST and DeCAF classifiers. These findings nominate tumor--stroma coupling as a reproducible prognostic state in PDAC.
