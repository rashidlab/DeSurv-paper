...
<!-- ============================================================
     EDITOR'S SUMMARY (Nature ~75 words, 3 sentences, plain-language).
     Draft below derived from the prior PNAS Significance Statement;
     trim and reframe for the chosen Nature venue before submission.
     ============================================================ -->

\noindent\textbf{Editor's Summary.} Bulk tumor expression reflects a mixture of cancer cells and surrounding normal tissue, and the gene programs that dominate this variance are often not the ones that predict patient outcomes. The authors present DeSurv, a survival-supervised matrix-factorisation framework that learns prognostically informative gene programs during discovery rather than after. In pancreatic cancer, DeSurv recovers a compact three-program decomposition that generalises across five independent cohorts and stratifies survival more reliably than standard unsupervised factorisation.
