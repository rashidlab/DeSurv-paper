...
\subsection{The D1 coupling axis is recovered by survival supervision, not by DeSurv specifically}
...
If the D1 tumour--stroma coupling were an artifact of DeSurv's particular
...
high-variance D2/D3 stroma--Basal axis. The coupling is thus a property of
...
Independently of survival, the $D_1$ program score correlated with protein-level GATA6 in-situ hybridisation in the COMPASS cohort (Spearman $\rho = `r sprintf("%.2f", .tcs$gata6$rho)`$, `r .pfmt(.tcs$gata6$p)`, $n = `r .tcs$gata6$n`$), validating the Classical/GATA6 identity of $D_1$ beyond the signature-level correlations in the main-text factor--signature heatmap.
