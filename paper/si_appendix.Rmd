...
no external validation cohort contributed to training, scoring, cutpoint selection, or
tuning. Validation-cohort survival outcomes were used only for the final, out-of-sample
