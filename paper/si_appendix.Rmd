...
programs from the deCAF study [@peng2024determination]; iCAF-like and myCAF-like CAF subtypes from SCISSORS [@leary2023s]; tumor,
...
```{r fig-converge, fig.width = 5, fig.height= 3, fig.cap="Convergence of model across initializations." , fig.env='figure*', fig.pos='htbp', out.height= "3in", out.width='5in'}
