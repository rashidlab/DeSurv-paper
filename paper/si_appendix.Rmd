...
knitr::include_graphics("../figures/si_fig_sim_null_mixed_tcgacptac.pdf")
```
...
knitr::include_graphics("../figures/cv_grid/cv_cindex_by_k_primary.pdf")
```
...
knitr::include_graphics("../figures/si_fig_nmf_diagnostics_tcgacptac.pdf")
```
...
knitr::include_graphics("../figures/si_fig_cutpoint_km_tcgacptac.pdf")
```
...
knitr::include_graphics("../figures/si_fig_subtype_overlap_tcgacptac.pdf")
```
...
knitr::include_graphics("../figures/si_fig_desurv_k5_heatmap_tcgacptac.pdf")
```
...
knitr::include_graphics("../figures/si_fig_nmf_k5_heatmap_tcgacptac.pdf")
```
...
knitr::include_graphics("../figures/si_fig_nmf_k7_heatmap_tcgacptac.pdf")
```
...
knitr::include_graphics("../figures/si_fig_varsurvival_k5_tcgacptac.pdf")
```
